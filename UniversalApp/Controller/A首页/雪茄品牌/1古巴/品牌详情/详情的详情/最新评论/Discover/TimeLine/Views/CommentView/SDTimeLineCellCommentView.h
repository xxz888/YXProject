...
@property (nonatomic, strong) MLLinkLabel *likeStringLabel;

- (void)setupWithLikeItemsArray:(NSArray *)likeItemsArray commentItemsArray:(NSArray *)commentItemsArray;

@property (nonatomic, copy) void (^didClickCommentLabelBlock)(NSString *commentId, CGRect rectInWindow);
@property (nonatomic, copy) void (^didClickLongCommentLabelBlock)(NSString *commentId, CGRect rectInWindow,NSInteger tag);
