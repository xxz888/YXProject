...
//        NSArray *dictArray = @[@{@"text":@"",@"time":@"",@"type":@""}];
...
- (void) createTableView
{
    ...
    self.inputTextField = [[UITextField alloc] initWithFrame:CGRectMake(50, 15, kScreenWidth - 100, 32)];
    //给文本输入框添加左边视图
...
//    self.inputTextField.layer.borderColor = [UIColor grayColor].CGColor;
    self.inputTextField.backgroundColor = kRGBA(245, 245, 245, 1);
